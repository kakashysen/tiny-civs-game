export const ACTIONS = Object.freeze({
  ...
  PREPARE_WARM_MEAL: 'prepare_warm_meal',
...
export const ACTION_VALUES = Object.freeze({
  ...
  [ACTIONS.GATHER_FIBER]: { fiber: 2, energyCost: 2, hungerDelta: 4 },
  [ACTIONS.CRAFT_CLOTHES]: { energyCost: 3, hungerDelta: 4 },
  [ACTIONS.PREPARE_WARM_MEAL]: { energyCost: 1, hungerDelta: -8 },
...
export const ADULT_ALLOWED_ACTIONS = Object.freeze([
  ACTIONS.GATHER_FOOD,
  ACTIONS.GATHER_WOOD,
  ACTIONS.GATHER_FIBER,
  ACTIONS.CRAFT_CLOTHES,
  ACTIONS.PREPARE_WARM_MEAL,
  ACTIONS.BUILD_SHELTER,
  ACTIONS.BUILD_STORAGE,
  ACTIONS.CARE,
  ACTIONS.REST,
...
export const ACTION_DURATION_MINUTES = Object.freeze({
  ...
  [ACTIONS.GATHER_FIBER]: 30,
  [ACTIONS.CRAFT_CLOTHES]: 50,
  [ACTIONS.PREPARE_WARM_MEAL]: 20,
